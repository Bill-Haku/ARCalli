...
var userInfoDemo = userInfo(name: "神笔马良", userHeadImg: UIImage(named: "MaLiang"), level: "笔友（LV.2）", motto: "每天进步一点点", following: 55, followed: 12, myWorksTot: 24, myWorksARed: 13, collections: 68, myReplys: 108, evaluations: 91, evaluationImg: UIImage(named: "DataLine"))
